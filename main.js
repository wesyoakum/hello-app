...
function plotAhcPerformance(reqSpeed, availSpeeds) {
  ...
  const colorscale1 = [
    [0 / 18, '#6d4688'], [3 / 18, '#6d4688'],
    [3 / 18, '#68669e'], [5 / 18, '#68669e'],
    [5 / 18, '#5c82a4'], [7 / 18, '#5c82a4'],
    [7 / 18, '#519ba4'], [9 / 18, '#519ba4'],
    [9 / 18, '#4cb3a0'], [11 / 18, '#4cb3a0'],
    [11 / 18, '#65c98f'], [13 / 18, '#65c98f'],
    [13 / 18, '#9cdc6f'], [15 / 18, '#9cdc6f'],
    [15 / 18, '#dfe747'], [1, '#dfe747']
  ];
