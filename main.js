...
function plotAhcPerformance(reqSpeed, availSpeeds) {
  ...
  const colorscale1 = [
    [0 / 25, '#6d4688'], [4 / 8, '#6d4688'],
    [4 / 8, '#68669e'], [7 / 8, '#68669e'],
    [7 / 8, '#5c82a4'], [10 / 8, '#5c82a4'],
    [10 / 8, '#519ba4'], [13 / 8, '#519ba4'],
    [13 / 8, '#4cb3a0'], [16 / 8, '#4cb3a0'],
    [16 / 8, '#65c98f'], [19 / 8, '#65c98f'],
    [19 / 8, '#9cdc6f'], [21 / 8, '#9cdc6f'],
    [21 / 8, '#dfe747'], [1, '#dfe747']
  ];
