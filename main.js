...
function plotAhcPerformance(reqSpeed, availSpeeds) {
  ...
  const colorscale1 = [
    [0 / 25, '#6d4688'], [4 / 25, '#6d4688'],
    [4 / 25, '#68669e'], [7 / 25, '#68669e'],
    [7 / 25, '#5c82a4'], [10 / 25, '#5c82a4'],
    [10 / 25, '#519ba4'], [13 / 25, '#519ba4'],
    [13 / 25, '#4cb3a0'], [16 / 25, '#4cb3a0'],
    [16 / 25, '#65c98f'], [19 / 25, '#65c98f'],
    [19 / 25, '#9cdc6f'], [21 / 25, '#9cdc6f'],
    [21 / 25, '#dfe747'], [1, '#dfe747']
  ];
