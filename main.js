...
function plotAhcPerformance(reqSpeed, availSpeeds) {
  ...
  const colorscale1 = [
    [0 / 9, '#6d4688'], [1.5 / 9, '#6d4688'],
    [1.5 / 9, '#68669e'], [2.5 / 9, '#68669e'],
    [2.5 / 9, '#5c82a4'], [3.5 / 9, '#5c82a4'],
    [3.5 / 9, '#519ba4'], [4.5 / 9, '#519ba4'],
    [4.5 / 9, '#4cb3a0'], [5.5 / 9, '#4cb3a0'],
    [5.5 / 9, '#65c98f'], [6.5 / 9, '#65c98f'],
    [6.5 / 9, '#9cdc6f'], [7.5 / 9, '#9cdc6f'],
    [7.5 / 9, '#dfe747'], [1, '#dfe747']
  ];
