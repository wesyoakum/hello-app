...
function plotAhcPerformance(reqSpeed, availSpeeds) {
  ...
  const colorscale1 = [
    [0 / 24, '#6d4688'], [4 / 24, '#6d4688'],
    [4 / 24, '#68669e'], [7 / 24, '#68669e'],
    [7 / 24, '#5c82a4'], [10 / 24, '#5c82a4'],
    [10 / 24, '#519ba4'], [13 / 24, '#519ba4'],
    [13 / 24, '#4cb3a0'], [16 / 24, '#4cb3a0'],
    [16 / 24, '#65c98f'], [19 / 24, '#65c98f'],
    [19 / 24, '#9cdc6f'], [21 / 24, '#9cdc6f'],
    [21 / 24, '#dfe747'], [1, '#dfe747']
  ];
