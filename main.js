...
function plotAhcPerformance(reqSpeed, availSpeeds) {
  ...
  const colorscale1 = [
    [0 / 10, '#ffffff'], [1 / 10, '#ffffff'],
    [1 / 10, '#6d4688'], [2 / 10, '#6d4688'],
    [2 / 10, '#68669e'], [3 / 10, '#68669e'],
    [3 / 10, '#5c82a4'], [4 / 10, '#5c82a4'],
    [4 / 10, '#519ba4'], [5 / 10, '#519ba4'],
    [5 / 10, '#4cb3a0'], [6 / 10, '#4cb3a0'],
    [6 / 10, '#65c98f'], [7 / 10, '#65c98f'],
    [7 / 10, '#9cdc6f'], [8 / 10, '#9cdc6f'],
    [8 / 10, '#dfe747'], [9 / 10, '#dfe747'],
    [9 / 10, '#ffffff'], [10, '#ffffff']
  ];
